...
`docs/NEXT_TASKS.md`의 론칭 티켓 순서를 따르세요 (P0 → P1 → P2):

1. MM-401 verify-business 요청자 인증 (보안 구멍)
2. MM-402 챗봇 실매물 연동 + 데모 매물 배지/차단
3. MM-403 비밀번호 재설정·회원 탈퇴·카카오 닉네임 폴백
4. MM-404 판매자 루프 (내 매물 DB 연동·받은 문의함·수정·판매완료)
5. MM-405 이용약관·개인정보처리방침
6. MM-406 [사용자] 도메인 + Resend 인증

설계 원칙: **모든 업무 자동화** — 운영자 수동 개입이 필요한 설계 금지.
