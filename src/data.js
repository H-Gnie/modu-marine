...
const RAW_LISTINGS = [
  ...
  {id:12,title:'가와사키 STX-15F',category:'제트스키',brand:'Kawasaki',model:'STX-15F',year:2015,price:890,location:'강원 춘천',marina:'의암 선착장',hours:445,length:'3.20m',engine:'제트 78마력',seller:'실소유 개인',badges:['직거래'],video:false,trailer:false,created:'2026-05-07',score:76,image:'https://images.unsplash.com/photo-1505867798796-639ec7e8cdf5?auto=format&fit=crop&w=900&q=80',market:'AI시세 980만원 · 9% 낮음',inspection:{선체:'B',엔진:'B',전장:'B',추진계:'B',부식:'경미',시운전:'가능'},desc:'입문용 저가 제트스키, 상태 양호.'},
  ...
  {id:17,title:'퀵실버 액티브 605 피시',category:'낚시보트',brand:'Quicksilver',model:'Activ 605 Fish',year:2021,price:3200,location:'경남 통영',marina:'통영항',hours:176,length:'6.10m',engine:'아웃보드 115마력',seller:'실소유 개인',badges:['모두진단'],video:false,trailer:true,created:'2026-05-02',score:87,image:'https://images.unsplash.com/photo-1598597285544-73cde918c78d?auto=format&fit=crop&w=900&q=80',market:'AI시세 3,400만원 · 6% 낮음',inspection:{선체:'A',엔진:'B+',전장:'B+',추진계:'A',부식:'양호',시운전:'예약 가능'},desc:'남해 낚시 전용, GPS어탐 장착.'},
  ...
  {id:24,title:'조디악 프로 5.5',category:'RIB',brand:'Zodiac',model:'Pro 5.5',year:2017,price:2750,location:'전남 완도',marina:'완도항',hours:322,length:'5.80m',engine:'아웃보드 130마력',seller:'실소유 개인',badges:['직거래'],video:false,trailer:true,created:'2026-04-25',score:81,image:'https://images.unsplash.com/photo-1685720543627-a49e4754dd0a?auto=format&fit=crop&w=900&q=80',market:'AI시세 3,100만원 · 11% 낮음',inspection:{선체:'B+',엔진:'B',전장:'B',추진계:'B+',부식:'경미',시운전:'가능'},desc:'남해 섬 탐방용, 실사용 흔적 있음.'},
  ...
  {id:30,title:'하이필드 패트롤 860',category:'RIB',brand:'Highfield',model:'Patrol 860',year:2021,price:7200,location:'부산 기장',marina:'기장 마리나',hours:108,length:'8.50m',engine:'아웃보드 350마력 쌍엔진',seller:'제휴 마리나',badges:['모두인증','모두진단','홈배송'],video:false,trailer:false,created:'2026-04-19',score:94,image:'https://images.unsplash.com/photo-1601210596001-ae2676f7ef6b?auto=format&fit=crop&w=900&q=80',market:'AI시세 7,600만원 · 5% 낮음',inspection:{선체:'A',엔진:'A',전장:'A',추진계:'A',부식:'양호',시운전:'완료'},desc:'고속 대형 RIB, 해양레포츠 센터 운영용.'}
];
